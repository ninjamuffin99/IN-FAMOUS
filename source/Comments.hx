...
class Comments 
{
	...
	public static function commentGen(sentType:Int = 0):String
	{
		...
		{
			var nameCalled:Array<String> = ["retard", "retardo", "autist", "idiot", "weeb", "incel", "virgin", "wannabe", "nazi", "feminazi", "feminist", "prevert", "perv", "scumbag", "douche", "douchbag", "dickhead", "hero", "god", "legend", "bastard", "beast", "hack", "phoney", "garbage human being", "awful person", "cuck", "cuckold", "cuckhold", "sicko", "sick bastard"];
			var intro:Array<String> = ["you are such a ", "you are a ", "ur a ", "u r a ", "You're a"];
			var mid:Array<String> = ["", "fucking ", "fricken ", "goddamn ", "flipping ", "gosh dang ", "mega ", "unfunny ", "fudging ", "ducking ", "motherfucking "];
